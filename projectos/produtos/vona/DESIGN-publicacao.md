# DESIGN · Surface 4 · Publicação · cidadão lê

**Persona** · público · qualquer leitor · sem login.
**Hora** · 14h32 · 10 minutos depois do acidente.
**Princípios servidos** · 1 (cidadão é fonte) · 6 (transparência mensal).
...
**Cena 4 · home do site CJC-MZ · cronológico.** Sem trending · sem algoritmo · sem "mais lidos". Notícia destacada (Cândida) + 5 outras do dia. Sem ads · sem tracking · sem login para ler.

**Cena 5 · correcção · 15h17 · 1 ferido virou 2.** Banner amarelo · transparente · "actualizada às 15h17 · INEM confirmou 2 feridos". Versão original preservada e linkable. 3 tipos de actualização · adição · correcção · retracção.

**Cena 6 · sem botão "share" · sem viralização por desenho.** Apenas URL copy. 4 razões · anti-viralização · sem performance metric · sem feedback loops tóxicos · privacidade do leitor. Comparar com Twitter.

**Cena 7 · sem comentários · 3 canais alternativos.** Submeter testemunho adicional · reportar erro · carta ao editor. Cada um moderado · cada um produz output útil · cada um respeita propósito.
...
- Sem botão "share Facebook" · "tweet" · "WhatsApp"
- Sem contador de likes / views
- Sem botão "follow author"
- Sem reactions (👍 ❤ 😱)
- Sem "trending now"
- Sem "mais lidos do dia"
- Sem comentários abertos
- Sem login obrigatório para ler
- Sem paywall
- Sem newsletter pop-up

## Tipografia editorial

Plex Serif para headlines · deck e corpo. Plex Sans para badges · meta · UI elements. Plex Mono para timestamps · GPS · IDs. Tom · revista séria · não app social. Cada família tem propósito · não decorativo.
